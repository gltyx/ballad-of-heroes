...
var cnItems = {
    ...
    ", but you feel this Archer matches you in the same way. As your fight comes to a stalemate, you raise your hands in surrender.": "，但你觉得这个射手和你一样匹配。 当你的战斗陷入僵局时，你举起双手投降。",
    ". The goddess": ". 女神",
    ...
    "Zosime is assigned to the Archer class. Click for details on class.": "佐西美 被分配到 射手 职业。 点击了解课程详情。",
    ...
    "Theseus": "忒修斯",
    "Towns offer respite and the opportunity to trade. Every few seconds, you will regain HP. Click the 'General' option to see new equipment options.": "城镇提供休息和贸易机会。 每隔几秒，您将恢复 HP。 单击“常规”选项以查看新装备选项。",
    ...
    "You reply.": "你回复。",
    "You've acquired your first equipment item. Click on 'Adventurer' on the top left of the screen to quickly jump to the menu and view the character page. Use the 'Change Equipment' button to update your equipment.": "你已经获得了你的第一件装备。 点击屏幕左上角的“冒险者”可以快速跳转到菜单并查看角色页面。 使用“更改装备”按钮更新您的装备。",
    ...
    "Increase Overdrive Gauge After": "之后增加超频仪表",
    ...
    "Large Charm of Artemis:": "阿尔忒弥斯的大魅力：",
    ...
    "Jewelcrafting": "珠宝加工",
    "Jewelcrafting allows you to create items that augment your equipment, either through making gems that can slot into items to increase their stats or adding slots to existing equipment.": "Jewelcrafting 允许您创建可以增强您装备的物品，方法是制作可以放入物品中以增加其属性的宝石，或为现有装备添加插槽。",
    ...
    "Uncommon (★★)": "罕见 (★★)",
    "uncommon recipes": "不常见的配方",
    "unique recipes": "独特的配方",
    ...
    "Snapjaw": "钳嘴",
    "Orpheus": "俄耳甫斯",
    "Overdrive Gain From Auto Attacks Bonus:": "自动攻击加成超频增益：",
    ...
    "Toggle Auto Character 1 Overdrive": "切换自动角色 1 超频",
    ...
    "Toggle Auto Character 2 Overdrive": "切换自动角色 2 超频",
    ...
    "Use Character 1 Overdrive": "使用角色 1 超频",
    ...
    "Use Character 2 Overdrive": "使用角色 2 超频",
    ...
    "Increase the amount of overdrive gauge gained from all attacks and being attacked.": "增加从所有攻击和被攻击中获得的超频计量表数量。",
    "Increase Water damage dealt.": "增加水属性伤害。",
    "Inflict a": "造成",
    "Lord of the Underworld": "冥界之主",
    "Nemea": "尼米亚",
    "Overdrive Point Gain From Ability Use:": "从能力使用中获得超频点：",
    "Overdrive Point Gain From Auto Attacks:": "自动攻击带来的超频点数增益：",
    "Overdrive Point Gain From Being Attacked:": "受到攻击后获得的超频点数：",
    "Protection": "保护",
    "Quickness": "速度",
    ...
    "The Archer class focuses on debilitating enemies with access to damage over time and stunning effects.": "射手职业专注于削弱敌人，并随着时间的推移造成伤害和惊人的效果。",
    ...
    "Total Overdrive Points Required:": "所需的总超频点：",
    ...
    "“If you could help me get back the rest of my materials, I sure would appreciate it!”": "“如果你能帮我拿回剩下的材料，我将不胜感激！”",
    "“My lifelong dream has been to travel Greece and trade amongst the people. To become the greatest merchant there ever was!": "“我一生的梦想是去希腊旅行并与人们进行贸易。 成为有史以来最伟大的商人！",
    "“Need some help?”": "“需要一些帮助？”",
    "“The best guards of the Pelopos Nisos, huh? I hope the crows take the lot of you!”": "“佩洛波斯尼索斯最好的后卫吧？ 我希望乌鸦能吃掉你们！”",
    "“What I need is my money back! …But yes, some help would be nice, thank you.”": "“我需要的是我的钱回来！ ......但是，是的，一些帮助会很好，谢谢。”",
    "approach him.": "接近他。",
    "asks as she helps the man lift a particularly heavy box full of various types of leather.": "她一边问道，一边帮助这名男子举起一个特别重的箱子，里面装满了各种皮革。",
    "By default, inactive classes gain no XP and inactive gods gain 25% XP from battle.": "默认情况下，不活跃的职业不会获得 XP，不活跃的神灵会从战斗中获得 25% XP。",
    "City Center": "城市中心",
    "City Center": "市中心",
    "Cleonea": "克利奥内亚",
    "Cleonea": "克里奥尼亚",
    "Aeëtes' Reinforcements": "埃厄忒斯的援军",
    "City Center": "城市中心",
    "Damage Over Time After": "随时间推移造成的损坏",
    "Earthen Husk": "土质外壳",
    "Empty Husk": "空壳",
    "Fire Damage Dealt Up": "造成火灾伤害",
    "Frenzied Bees": "疯狂的蜜蜂",
    "Increase Fire Damage Dealt by all party members by 6.25%.": "所有小队成员造成的火焰伤害增加 6.25%。",
    "Khalkotauroi A": "哈尔科陶罗伊A",
    "Khalkotauroi B": "哈尔科陶罗伊 B",
    "Large Scorpion": "大蝎子",
    "Luck Up": "好运",
    "Material": "材料",
    "Nemea - Cleonea": "尼米亚 - 克利奥尼亚",
    "Nemea - Country Roads": "尼米亚 - 乡村道路",
    "On your return trip to Nemea, you stop at the small village of Cleonea to prepare for": "在返回尼米亚的途中，您会在克利奥尼亚小村庄停留，为",
    "Shuffling Husk": "拖曳的外壳",
    "The man says as he struggles to put the box into place.": "男人边说边费力地将盒子放好。",
    "Thick Leather": "厚皮革",
    "Trader": "商人",
    "You hear him muttering as you and": "你听到他在你和",
    "Your party can consist of at most 2 classes and 4 gods.": "你的队伍最多可以由 2 个职业和 4 个神组成。",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to reduce a target's Agility by 20% for 14 seconds. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "对队员的武器施加毒素，使他们的自动攻击有 10% 的几率降低目标的敏捷性 20%，持续 14 秒。 持续30分钟。 每个队员一次只能使用一种毒素。 这种效应在死亡后仍持续存在。",
    "+50 Luck Permanently For Entire Party": "+50 永久运气对于整个队伍",
    "340% of HP Loss": "生命值损失 340%",
    "5 Rough Aquamarine Fragment": "5 海蓝宝石原石碎片",
    "5 Rough Opal Fragment": "5 蛋白石原石碎片",
    "5 Rough Ruby Fragment": "5 红宝石碎片原石",
    "Basic (★)": "基础（★）",
    "basic recipes": "基本配方",
    "Bloodlust": "嗜血",
    "chance to retain materials:": "保留材料的机会：",
    "gem upgrade chance:": "宝石升级几率：",
    "Hefty Stone": "大石头",
    "Mugger": "抢劫者",
    "Mugger A": "劫匪A",
    "Mugger B": "抢劫者B",
    "Not Currently Brewing": "目前尚未酝酿",
    "Not Currently Crafting": "目前未制作",
    "of the damage dealt every 4 seconds for": "每 4 秒造成的伤害",
    "Onslaught": "猛攻",
    ...
    "rare recipes": "稀有配方",
    "recipe book": "配方",
    "recipes obtained:": "获得的配方：",
    "Reduce your own current HP by 10%. Apply a damage over time effect to all targets that deals": "自身当前生命值减少10%。 对所有造成伤害的目标施加持续伤害效果",
    "Restorative Herb": "恢复性药草",
    "Revel in Blood": "陶醉于鲜血之中",
    "Rupture": "破裂",
    "Shining Stone": "闪亮的石头",
    "Targeted Effect Duration Increase:": "目标效果持续时间增加：",
    "Each follower provides a 2% chance per minute to pray to a random god and receive a free Small Altar boon for the party. This does not require a condition to be met or an Activatable Altar to be activated. You cannot benefit from the same exact boon more than once at a time.": "每个追随者每分钟有 2% 的机会向随机神祈祷并为队伍获得免费的小祭坛恩惠。 这不需要满足条件或激活可激活祭坛。 您一次不能多次从同一个福利中受益。",
    "Each follower provides a 25% chance per minute to automatically activate any Small Activatable Altar whose condition is met. Activatable Altars are the three altars displayed in the quick view menu that can be activated after completing the required condition.": "每个追随者每分钟有 25% 的机会自动激活任何满足条件的小型可激活祭坛。 可激活祭坛是快速查看菜单中显示的三个祭坛，在完成所需条件后可以激活。",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to deal an additional 65 damage. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "对队员的武器施加毒素，使他们的自动攻击有 10% 的几率造成额外 65 点伤害。 持续30分钟。 每个队员一次只能使用一种毒素。 这种效应在死亡后仍持续存在。",
    "Add Loadout": "添加装载",
    "Chthonic Favor:": "阴间恩惠：",
    "Coast of Crete": "克里特岛海岸",
    "Copy Current Setup": "复制当前设置",
    "Desert Locust Swarm": "沙漠蝗群",
    "Egyptian Cobra": "埃及眼镜蛇",
    "Fill 10% of a party member's Overdrive gauge. 12 second cooldown.": "填充队伍成员超速槽的 10%。 12 秒冷却时间。",
    "Garden of the Hesperides": "赫斯珀里得斯花园",
    "Hidden Oasis": "隐藏的绿洲",
    "Moroccan Coast": "摩洛哥海岸",
    "Increase Chthonic Power gain by 23%.": "冥神力量增益增加 23%。",
    "Increase user's max HP by 10% for 30 minutes. Only one elixir can be active per party member at a time. This effect persists on death.": "30分钟内使自身最大生命值增加10%。 每个队员一次只能激活一种圣水。 这种效应在死亡后仍持续存在。",
    "Keep Equipped Armor": "保留装备的盔甲",
    "Keep Equipped Necklace": "保留装备的项链",
    "Keep Equipped Ring": "保留装备的戒指",
    "Keep Equipped Shield": "保留装备的盾牌",
    "Keep Equipped Weapon": "保留装备的武器",
    "Lerna": "莱尔纳",
    "Loadouts": "装载",
    "Mount Erymanthos": "埃律曼索斯山",
    "Multiple Target Damage Dealt Up": "对多个目标造成伤害",
    "Name:": "名称：",
    "Poison all enemies, dealing 35 damage every 2 seconds for 8 seconds.": "使所有敌人中毒，每 2 秒造成 35 点伤害，持续 8 秒。",
    "Poison an enemy, dealing 28 damage every 3 seconds for 9 seconds.": "使一名敌人中毒，每 3 秒造成 28 点伤害，持续 9 秒。",
    "Poison Extract Potion": "毒药提取液",
    "Poisonous Toxin": "有毒的毒素",
    "Rhinoceros A": "犀牛A",
    "Rhinoceros B": "犀牛B",
    "Sand Boa": "沙蟒蛇",
    "Stymphalia": "斯廷法利亚",
    "Unequip All Characters Before Swap": "交换之前取消所有角色的装备",
    "View Loadouts": "查看装载",
    "You can assign a follower to automatically activate your altars and pray for boons, giving you an edge in battle.": "您可以指定一名追随者自动激活您的祭坛并祈祷恩赐，让您在战斗中获得优势。",
    "Alchemist": "炼金术士",
    "Chthonic Favor": "冥府之恩",
    "Lost Haven": "失落的避风港",
    "Palace of Hades": "哈迪斯宫殿",
    "2%. Effect lasts for 30 seconds.": "2%。 效果持续30秒。",
    "affinity bonuses": "亲和力奖励",
    "Base Boon Duration Increase:": "基础增益持续时间增加：",
    "Base Boon Effectiveness Increase:": "基础增益效果增加：",
    "God XP Increase:": "神XP增加：",
    "Increase Fire Damage Dealt by all party members by 2%. Effect lasts for 30 seconds.": "所有小队成员造成的火焰伤害增加 2%。 效果持续30秒。",
    "Increase Max HP of all party members by 5%. Effect lasts for 30 seconds.": "所有队员的最大生命值增加5%。 效果持续30秒。",
    "Increase the damage of any attack that hits multiple enemies by 2%. Effect lasts for 30 seconds.": "攻击多个敌人时造成的伤害提高 2%。 效果持续30秒。",
    "Large Charms:": "大号吊饰：",
    "Max HP Up": "最大生命值上升",
    "Small Charms:": "小饰品：",
    "When the duration expires, apply a Damage over Time effect on all enemies, dealing 50 damage every 3 seconds for 12 seconds. Effect lasts for 30 seconds.": "持续时间结束后，对所有敌人施加持续伤害效果，每 3 秒造成 50 点伤害，持续 12 秒。 效果持续30秒。",
    "When the duration expires, fill 2% of each party member's Overdrive gauge. Effect lasts for 30 seconds.": "持续时间结束后，将每位队员的超速量表填充至 2%。 效果持续30秒。",
    "+10% Ability Cooldown Reduction": "+10% 技能冷却时间减少",
    "+15% Air Damage Bonus": "+15% 空气伤害加成",
    "+7.5% Armor Penetration": "+7.5% 护甲穿透",
    "+7.5% Multiple Target Damage Increase": "+7.5% 多重目标伤害增加",
    "Acheron": "黄泉",
    "African Wolf": "非洲狼",
    "Alluring Siren": "诱人的海妖",
    "Blessed Shade": "祝福之影",
    "Bloody Necklace": "血腥项链",
    "DOT": "点",
    "Drowned Abomination": "溺水憎恶",
    "Elysian Fields": "极乐世界",
    "Gates of Horn and Ivory": "角与象牙之门",
    "Open Plains": "开阔平原",
    "Water-logged Marsh": "浸水沼泽",
    "Waves of Oceanus": "海神之波",
    "Winding Paths": "蜿蜒的路径",
    "Erytheia": "厄律忒亚岛",
    "Cádiz": "加的斯",
    "Geryon's Farm": "格律翁农场",
    "Lush Valley": "郁郁葱葱的山谷",
    "Pillars of Heracles": "赫拉克勒斯之柱",
    "Western Ocean Waters": "西大洋水域",
    "Geryon": "革律翁",
    "Light Shield": "光盾",
    "Safe Ring": "安全戒指",
    "Shade of Hypnos": "许普诺斯之影",
    "Soaring Falcon": "翱翔的猎鹰",
    "Spirit Shield": "灵魂之盾",
    "Spotted Viper": "斑点毒蛇",
    "Ferry Ride": "乘坐渡轮",
    "Hypnos' Island": "许普诺斯岛",
    "River Divergence": "河流分流",
    "Still Waters": "静水",
    "Twisted Soul": "扭曲的灵魂",
    ", also immediately auto attack after any damage dealing attack from an enemy forced to target you. Passive.": "，在敌人被迫以你为目标的攻击造成任何伤害后也会立即自动攻击。 被动的。",
    "Counterattack": "反击",
    "Draw a target's focus for the next": "画出下一个目标的焦点",
    "of the damage back to them. If your HP is below": "将伤害返还给他们。 如果你的HP低于",
    "Quicken": "加速",
    "seconds, forcing all attacks to target you. Also, apply a debuff on the target that increases their damage taken from Thorns effects by": "秒，迫使所有攻击都瞄准你。 此外，对目标施加减益效果，使荆棘效果造成的伤害增加",
    "Sirensong Ring:": "海妖之歌戒指：",
    "When an enemy is forced to auto attack you, deal": "当敌人被迫自动攻击你时，处理",
    "Your overconfidence led to some missteps and you now find yourself in the Underworld. Many heroes have had their dealings in Hades' realm and you are no exception. Your journey continues to Elysium and, if you can obtain Hades's blessing, back to the surface.": "你的过度自信导致了一些失误，你现在发现自己身处地狱。 许多英雄都曾在哈迪斯的领域里打过交道，你也不例外。 你的旅程将继续前往极乐世界，如果你能获得哈迪斯的祝福，就可以返回地面。",
    "Alpha Grey Wolf": "阿尔法灰太狼",
    "Altar of Asclepius": "阿斯克勒庇俄斯祭坛",
    "Armored Revenant": "装甲亡魂",
    "Armored Revenant x2": "装甲亡魂 x2",
    "Asphodelus": "水星属",
    "At Zosime's request, you take a detour to Calydon to follow through Atalanta's story. You visit her birthplace and then traverse the forest where she finally put a stop to the monstrous boar rampaging the countryside.": "应佐西姆的要求，你绕道前往卡利登，了解亚特兰大的故事。 你参观她的出生地，然后穿越森林，在那里她最终阻止了在乡村肆虐的可怕野猪。",
    "Bear Hide": "熊皮",
    "Bear Hides:": "熊皮：",
    "Bearskin Armor": "熊皮铠甲",
    "Bedazzled Ring": "眼花缭乱的戒指",
    "Blackfin": "黑鳍金枪鱼",
    "Blessed Shade x2": "祝福之影 x2",
    "Boar Hide": "野猪皮",
    "Boar Hides:": "野猪皮：",
    "Boarskin Armor": "野猪皮铠甲",
    "Bobcat": "山猫",
    "Bobcat x2": "山猫x2",
    "Broken Necklace": "项链断了",
    "Broken Necklaces:": "项链破损：",
    "Brown Bear": "棕熊",
    "Brown Bear x2": "棕熊x2",
    "Brown Bear x3": "棕熊 x3",
    "Butcher": "屠夫",
    "Cackling Spectre": "咯咯的幽灵",
    "Cackling Spectre x2": "咯咯幽灵 x2",
    "Calm Waters": "平静的水域",
    "Calydonian Boar": "卡吕冬野猪",
    "Carnivorous Flora": "食肉植物区系",
    "Carnivorous Flora x2": "食肉植物群 x2",
    "Centaur Mystic x2": "半人马秘法师 x2",
    "Click to view all.": "点击查看全部。",
    "damage after each auto attack or ability. 57.9 second cooldown.": "每次自动攻击或技能后造成的伤害。 57.9 秒冷却时间。",
    "damage to all targets. Repeat this for every element you attacked with since the last time it was used. 65.62 second cooldown.": "对所有目标造成伤害。 对自上次使用以来您攻击过的每个元素重复此操作。 65.62 秒冷却时间。",
    "Dead End": "死路",
    "Den Mother": "书房妈妈",
    "Deserted Path": "荒无人烟的小路",
    "Diving Cormorant": "潜水鸬鹚",
    "Diving Cormorant x2": "潜水鸬鹚 x2",
    "Drowned Abomination x2": "溺水憎恶 x2",
    "Dual-Wielding Butcher": "双持屠夫",
    "Dual-Wielding Butcher x2": "双持屠夫 x2",
    "Earth damage to all targets. 42.94 second cooldown.": "对所有目标造成地球伤害。 42.94 秒冷却时间。",
    "Empusa": "恩普萨",
    "Empusa x2": "恩普萨 x2",
    "Enflamed Salamander": "炎火蝾螈",
    "Engorged Shade": "膨胀的阴影",
    "Engorged Shade x2": "膨胀的阴影 x2",
    "Enraged Villager": "愤怒的村民",
    "Enraged Villager x2": "愤怒的村民 x2",
    "Essence of Fire": "火之精华",
    "Exiled Hoplite": "流亡重装步兵",
    "Exiled Hoplite x2": "流放重装步兵 x2",
    "Exploding Potion:": "爆炸药水：",
    "Exploding Soul": "爆炸灵魂",
    "Exploding Soul x2": "爆炸灵魂 x2",
    "Falcon": "鹘",
    "Feisty Badger": "精力旺盛的獾",
    "Feral Boar": "野猪",
    "Feral Boar x2": "野猪 x2",
    "Fire damage to all targets. 29.43 second cooldown.": "对所有目标造成火焰伤害。 29.43 第二次冷却时间。",
    "Fish Scale": "鳞",
    "Floating Flame": "漂浮的火焰",
    "Floating Flame x3": "浮游火焰 x3",
    "Focus Potion Recipe": "集中药水配方",
    "Forest Dryad": "森林树精",
    "Forest Dryad x2": "森林树精 x2",
    "Forest Passage": "森林通道",
    "Forest Wisp": "森林小精灵",
    "Fractured Amethyst Ring": "破碎的紫水晶戒指",
    "Fractured Aquamarine Ring": "破碎的海蓝宝石戒指",
    "Fractured Emerald Ring": "断裂的祖母绿戒指",
    "Fractured Opal Ring": "断裂蛋白石戒指",
    "Fractured Ruby Ring": "破碎的红宝石戒指",
    "Fractured Topaz Ring": "断裂托帕石戒指",
    "Frenzied Gull": "疯狂的海鸥",
    "Frenzied Gull x2": "狂怒海鸥 x2",
    "Golden Jackal": "金豺",
    "Golden Jackal x3": "金豺x3",
    "Grey Wolf": "灰狼",
    "Grey Wolf x2": "灰太狼x2",
    "Grey Wolf x3": "灰太狼 x3",
    "Griffon Vulture": "狮鹫",
    "Griffon Vulture x2": "狮鹫 x2",
    "Griffon Vulture x4": "狮鹫 x4",
    "Hardened Leather Armor": "硬化皮甲",
    "Harpy Talon": "鹰身女妖之爪",
    "Healing Poultice:": "治疗膏药：",
    "Healing Salve:": "治疗药膏：",
    "Heavy Thicket": "重灌木丛",
    "Hefty Stone:": "大石头：",
    "Hell Rider": "地狱骑士",
    "Hellespoint Passage 1": "海勒斯角通道 1",
    "Hellespoint Passage 2": "海勒斯角通道 2",
    "Highest XPS Achieved: 0": "达到的最高 XPS：0",
    "Horned Viper": "角蝰蛇",
    "Horned Viper x2": "角蝰蛇 x2",
    "Incoherent Banshee": "语无伦次的女妖",
    "Incoherent Banshee x2": "语无伦次的女妖 x2",
    "Increase parties' Defense by": "增加各方防御",
    "Increase parties' Luck by": "增加聚会的运气",
    "Increase parties' Max HP by": "各方最大生命值增加",
    "Increase parties' Resistance by": "增加各方的抵抗力",
    "Insane Soul": "疯狂的灵魂",
    "Insane Soul x2": "疯狂灵魂 x2",
    "Insane Soul x3": "疯狂灵魂 x3",
    "Island of Imbros": "因布罗斯岛",
    "Island of Lemnos": "利姆诺斯岛",
    "Jewelcrafter": "珠宝工匠",
    "Khalkotauroi": "哈尔科陶罗伊",
    "Khalkotauroi x2": "哈尔科陶罗伊 x2",
    "Large Charm of Ares:": "阿瑞斯的大魅力：",
    "Large Charm of Hades:": "哈迪斯的大魅力：",
    "Leopard": "豹",
    "Leopard x2": "豹子x2",
    "Lesser Cracked Amethyst": "小裂纹紫水晶",
    "Lesser Cracked Aquamarine": "小裂纹海蓝宝石",
    "Lesser Cracked Emerald": "小裂纹祖母绿",
    "Lesser Cracked Opal": "小裂纹蛋白石",
    "Lesser Cracked Ruby": "轻微裂纹红宝石",
    "Lesser Cracked Topaz": "小裂纹托帕石",
    "Longfin Mako": "长鳍灰鲭鲨",
    "Longfin Mako x2": "长鳍灰鲭鲨 x2",
    "Longfin Mako x4": "长鳍灰鲭鲨 x4",
    "Lost Soul": "失落的灵魂",
    "Lost Soul x2": "失落的灵魂x2",
    "Lousewort": "黄花菜",
    "Medusa": "美杜莎",
    "Metal Scraps": "金属废料",
    "Moray Eel x2": "海鳗 x2",
    ...
    "O": "氧",
    "Open Seas": "公海",
    "Overgrown Verdure": "杂草丛生的翠绿",
    "Patrinos Bandit": "帕特里诺强盗",
    "Patrinos Bandit x3": "帕特里诺强盗 x3",
    "Patrinos Gang Leader": "帕特里诺帮主",
    "Patrinos Rogue": "帕特里诺斯盗贼",
    "Patrinos Ruffian": "帕特里诺斯·鲁菲安",
    "Patrinos Ruffian x2": "帕特里诺斯恶棍 x2",
    "Pendant of Power": "力量吊坠",
    "Pendant of Speed": "速度坠饰",
    "Pit Viper": "蝮蛇",
    "Pit Viper x3": "毒蛇 x3",
    "Poison Spewing Fungi": "喷毒真菌",
    "Poison Spewing Fungi x2": "喷毒真菌 x2",
    "Propontis": "普罗桥",
    "Pushy Merchant": "咄咄逼人的商人",
    "Pushy Merchant x2": "咄咄逼人的商人 x2",
    "Pushy Merchant x3": "咄咄逼人的商人 x3",
    "Red Fox": "红狐",
    "Red Fox x2": "红狐x2",
    "Red-Speckled Toad": "红斑蟾蜍",
    "Red-Speckled Toad x2": "红斑蟾蜍 x2",
    "Reset Game": "重置游戏",
    "Restorative Herb:": "恢复性药草：",
    "River Karp": "卡普河",
    "River Karp x2": "卡普河 x2",
    "River Karp x3": "卡普河 x3",
    "River Karp x4": "卡普河 x4",
    "Rogue Nymph": "盗贼宁芙",
    "Rogue Nymph x2": "盗贼仙女 x2",
    "Rough Amethyst Fragment": "原石紫水晶碎片",
    "Rough Amethyst Fragments:": "紫水晶原石碎片：",
    "Rough Aquamarine Fragment": "海蓝宝石原石碎片",
    "Rough Aquamarine Fragments:": "海蓝宝石原石碎片：",
    "Rough Emerald Fragment": "祖母绿原石碎片",
    "Rough Ruby Fragment": "红宝石原石碎片",
    "Rough Topaz Fragment": "黄玉原石碎片",
    "Salmydessus": "鲑鱼",
    "Savage Bear": "野蛮熊",
    "Savage Bear x2": "野蛮熊 x2",
    "Sea Serpent": "海蛇",
    "Sea Serpent x2": "海蛇 x2",
    "Seashell": "贝壳",
    "Seashells:": "贝壳：",
    "Shady Traveler": "阴暗旅行者",
    "Shark Tooth": "鲨鱼牙",
    "Shield of the Healer": "治愈者之盾",
    "Shortfin Mako": "短鳍灰鲭鲨",
    "Show Tutorials As Modals": "将教程显示为模态框",
    "Show your devotion to the gods by using healing items on the Altar of Asclepius. Your devotion will be rewarded.": "通过在阿斯克勒庇俄斯祭坛上使用治疗物品来表达你对神的忠诚。 你的奉献将会得到回报。",
    "Small Black Kantharos:": "小黑坎塔罗：",
    "Small Bucchero Kantharos:": "小布切罗·坎塔罗斯：",
    "Small Charm of Ares:": "阿瑞斯的小魅力：",
    "Small Charm of Hades:": "哈迪斯小魅力：",
    "Small Cracked Kantharos:": "小破裂的坎塔罗斯：",
    "Small Gilded Kantharos:": "小镀金坎塔罗斯：",
    "Small Ornate Kantharos:": "小华丽的坎塔罗斯：",
    "Small Silver Kantharos:": "小银坎塔罗斯：",
    "Snapjaw x2": "钳嘴x2",
    "Snapper Swarm": "鲷鱼群",
    "Snapper Swarm x2": "鲷鱼群 x2",
    "Snapper Swarm x3": "鲷鱼群 x3",
    "Sorrel": "酢浆草",
    "Soul Spark": "灵魂火花",
    "Spirit Essence": "精神精华",
    "Spotted Salamander": "斑点蝾螈",
    "Spotted Salamander x3": "斑点蝾螈 x3",
    "Steel Hammer": "钢锤",
    "Stymphalian Vulture x2": "斯廷法利亚秃鹫 x2",
    "Sword of Flames": "火焰之剑",
    "Thales and Zosime begin to pick up their rhythm again and now take to the seas to follow in the footsteps of Jason and the Argonauts. As they travel east to Colchis, they soon realize that all is not quite like the stories.": "泰勒斯和佐西姆开始再次加快节奏，现在出海追随杰森和阿尔戈英雄的脚步。 当他们向东前往科尔基斯时，他们很快意识到一切并不像故事中那样。",
    "Trapper": "捕手",
    "Trapper x2": "陷阱x2",
    "Trek Across Arcadia": "徒步穿越阿卡迪亚",
    "Vial of Lake Lerna": "勒纳湖小瓶",
    "Vial of the Lethe": "忘川之瓶",
    "Vials of the Lake Lerna:": "勒纳湖的小瓶：",
    "Violet": "紫色",
    "Wandering Ibex": "流浪野山羊",
    "Wandering Ibex x2": "流浪野山羊 x2",
    "Wheel of Fire": "火轮",
    "Wheel of Fire x2": "火轮x2",
    "Woodland Nymph": "林地仙女",
    "Woodland Nymph x2": "林地仙女 x2",
    "Wretched": "可怜",
    "Wretched x2": "可怜x2",
    "Yellow-Speckled Toad": "黄斑蟾蜍",
    "Yellow-Speckled Toad x2": "黄斑蟾蜍 x2",
    "You finally feel ready to take on the trials of Heracles, the greatest of all mortals. Each step is a difficult one, but you gain new strength along the way.": "你终于准备好接受最伟大的凡人赫拉克勒斯的考验了。 每一步都是艰难的，但一路走来你会获得新的力量。",
    "Auto Attack Damage Up": "自动攻击伤害上升",
    "Eternal Melee Tickets and Chthonic Preferred God Resets are based on real time and not game time.": "永恒近战门票和闪灵首选神重置是基于实时而不是游戏时间。",
    "Increasing Luck and Attack by": "增加运气和攻击力",
    "next ability +10%": "下一个能力+10%",
    "Permanent Party XP Gain Bonus:": "永久队伍 XP 获得奖励：",
    "Up to 60 minutes of away time is automated. You can adjust the length of automated away time in the settings.": "最多 60 分钟的离开时间会自动进行。 您可以在设置中调整自动离开时间的长度。",
    "You can now empower your abilities in the form of Links. When you manually select an ability, you will activate a Link and deal increased damage. As you level up, you will be able to link more abilities together and deal increasingly higher damage with them.": "您现在可以通过链接的形式增强您的能力。 当您手动选择一个能力时，您将激活一个链接并造成更大的伤害。 随着你的升级，你将能够将更多的能力链接在一起，并用它们造成越来越高的伤害。",
    "All classes can use any weapon type without any penalty or boost.": "所有职业都可以使用任何武器类型，而不会受到任何惩罚或提升。",
    "As you proceed through the game, you will need to defeat enough enemies in an area before being able to move forward. You've won enough battles in the 'Upper Coast' subzone to continue. On the right side of the screen, select 'Bay' to move to the next subzone within the 'Aigosthena' zone. If you wish, you can select 'Auto Progress' at the top of the page to automatically move to the next subzone when possible. Continue to proceed through each subzone to progress the story.": "当你进行游戏时，你需要在一个区域中击败足够多的敌人才能继续前进。 您已经在“上海岸”分区赢得了足够多的战斗，可以继续前进。 在屏幕右侧，选择“海岸”以移动到“艾格斯特纳”区域内的下一个子区域。 如果您愿意，您可以选择页面顶部的“自动进度”，以便在可能的情况下自动移至下一个子区域。 继续穿过每个分区来推进故事。",
    "On the left side of your screen is your character information. Here you can see your character's health and all abilities available to you. Currently, you only have access to an auto attack that automatically deals attack damage to an enemy over time. Hover over the sword by your character's name for more details.": "屏幕左侧是您的角色信息。 在这里您可以看到角色的健康状况以及您可以使用的所有能力。 目前，您只能使用自动攻击，随着时间的推移自动对敌人造成攻击伤害。 将鼠标悬停在角色名称旁边的剑上以了解更多详细信息。",
    "Enemies are displayed in the middle of your screen. When you reduce all enemies' HP to 0, you will gain XP and immediately begin fighting a new set of enemies. Hover over an enemy's name to see more details about them.": "敌人显示在屏幕中央。 当你将所有敌人的 生命值 减少到 0 时，你将获得 经验值 并立即开始与一组新的敌人作战。 将鼠标悬停在敌人的名字上可以查看有关他们的更多详细信息。",
    ". View passive ability description by hovering your character's name.": "。 通过将鼠标悬停在角色的名字上来查看被动能力描述。",
    "Continue": "继续",
    "Hover over an enemy's name to see their stats, ability details, and possible loot.": "将鼠标悬停在敌人的名字上可以查看他们的统计数据、能力详细信息和可能的战利品。",
    "improves ability:": "提高能力：",
    "Skip Tutorials": "跳过教程",
    "Tutorial": "教程",
    "Up to 30 minutes of away time is automated. You can adjust the length of automated away time in the settings.": "最多 30 分钟的离开时间是自动的。 您可以在设置中调整自动离开时间的长度。",
    "(Aquarius)": "（水瓶座）",
    "Bonus Gods:": "奖励神：",
    "Continue progressing through the story to unlock hidden gods.": "继续推进故事情节，解锁隐藏的神灵。",
    "Duration:": "持续时间：",
    "Performance": "性能",
    "Show Game Log Time Stamps": "显示游戏日志时间戳",
    ...
    "Achievement": "成就",
    "click play in the header to resume": "单击标题中的“继续”以恢复",
    "completed! You gain": "已完成！你获得了",
    "game paused": "游戏已暂停",
    "You have been defeated. You quickly retreat and regroup.": "你被打败了。 你迅速撤退并重新集结。",
    "3 to all other primary stats": "3 至所有其他主要属性",
    "2% Boon of Olympus": "2% 奥林巴斯恩赐",
    "after each auto attack or ability. 60 second cooldown.": "每次自动攻击或技能后。 60 秒冷却时间。",
    "Auto Attack Speed:": "自动攻击速度：",
    "Chance For Party To Be Critically Hit:": "队伍受到严重打击的几率：",
    "Defeat 10 more times for more info.": "再击败 10 次以获取更多信息。",
    "Party Critical Hit Chance:": "队伍暴击几率：",
    "seconds, increase your Damage Dealt by": "秒，增加你造成的伤害",
    "You can purchase items from stores in bulk by using the CTRL, ALT, and SHIFT keys.": "您可以使用 CTRL、ALT 和 SHIFT 键从商店批量购买商品。",
    "Followers": "追随者",
    "Each follower provides a 25% chance per minute to automatically activate any Small Activatable Altar whose condition is met. Activatable Altars are the  altars displayed in the quick view menu that can be activated after completing the required condition.": "每个追随者每分钟有 25% 的机会自动激活任何满足条件的小型可激活祭坛。 可激活祭坛是快速查看菜单中显示的祭坛，在完成所需条件后可以激活。",
    "(Pisces)": "（双鱼座）",
    "Resources & Key Items": "资源 & 关键物品",
    "Click on 'LOG' on the top right of your screen to review any Story scene.": "点击屏幕右上角的“日志”查看任何故事场景。",
    "are like story chapters and contain Zones and Subzones where you will fight increasingly more difficult enemies. You are currently on:": "就像故事章节一样，包含区域和子区域，在那里你将与越来越难对付的敌人战斗。您当前所在的位置：",
    "Show Pause Message": "显示暂停消息",
    "You can adjust game performance in the Settings to": "您可以在“设置”中调整游戏性能",
    "Show Big Number Colors": "显示大数字颜色",
    "for a less CPU and battery intensive experience. If you want a smoother but more CPU and battery intensive experience, choose": "以获得更少的 CPU 和电池密集型体验。 如果您想要更流畅但更多 CPU 和电池密集型体验，请选择",
    "+1 Large Charm of Fire Protection": "+1 大防火护符",
    "+1 Large Cracked Kantharos": "+1 大型裂纹坎塔罗",
    "+1 Large Ornate Kantharos": "+1 大型华丽坎塔罗",
    "1 follower is  searching Aegean Sea for 3 Louseworts, 2 Shark Teeth and 3 Fish Scales.": "1 位关注者正在爱琴海寻找 3 个虱子草、2 个鲨鱼牙齿和 3 个鱼鳞。",
    "1 follower is  searching Aigosthena for 3 Light Leathers, 5 Throwing Stones, 3 Healing Herbs and 2 Waxes.": "1 位追随者正在艾戈斯泰纳寻找 3 块轻皮革、5 块投掷石、3 块治疗药草和 2 块蜡。",
    "1 follower is  searching Asphodel for 3 Soul Sparks, 2 Vials of the Lethe, 3 Essences of Fire and 4 Asphodeluses.": "1 位追随者正在搜索 Asphodelus，以获得 3 个灵魂火花、2 个忘川瓶、3 个火焰精华和 4 个 Asphodeluses。",
    "1 follower is  searching Black Sea for 2 Fish Scales, 3 Seashells and 3 Vial of The Black Seas.": "1 位关注者正在黑海中搜索 2 块鱼鳞、3 个贝壳和 3 瓶黑海。",
    "1 follower is  searching Calydon for 4 Goldroots, 2 Thick Leathers, 2 Louseworts and 4 Violets.": "1 位关注者正在 Calydon 中搜索 4 个金根、2 个厚皮、2 个虱子草和 4 个紫罗兰。",
    "1 follower is  searching Colchis for 3 Spirit Essences, 2 Rough Emerald Fragments and 2 Metal Scraps.": "1 位追随者正在科尔基斯寻找 3 个灵魂精华、2 个翡翠原石碎片和 2 个金属碎片。",
    "1 follower is  searching Elysium for 3 Vials of the Lethe, 2 Narcissuses, 2 Rough Ruby Fragments and 3 Healing Salves.": "1 位追随者正在极乐世界寻找 3 瓶忘川、2 个水仙、2 个红宝石碎片和 3 个治疗药膏。",
    "1 follower is  searching Isle of Libya for 3 Fennel, 2 Olives and 5 Petrified Barks.": "1 位关注者正在利比亚岛搜索 3 个茴香、2 个橄榄和 5 个石化树皮。",
    "1 follower is  searching Pelopos Nisos for 3 Vials of the Lake Lerna, 2 Rough Topaz Fragments, 2 Rough Amethyst Fragments and 2 Rough Opal Fragments.": "1 位关注者正在 Pelopos Nisos 中搜索 3 瓶勒纳湖、2 个黄玉原石碎片、2 个紫水晶原石碎片和 2 个蛋白石原石碎片。",
    "1 follower is  searching Road to Dodona for 3 Olives, 3 Leathers, 4 Fennel and 2 Lamia Hearts.": "1 位关注者正在搜索多多纳之路，寻找 3 个橄榄、3 个皮革、4 个茴香和 2 个拉米亚之心。",
    "1 follower is  searching The Lethe for 3 Spirit Essences, 2 Rough Emerald Fragments, 2 Rough Aquamarine Fragments and 2 Metal Scraps.": "1 位追随者正在忘川寻找 3 个灵魂精华、2 个祖母绿原石碎片、2 个海蓝宝石原石碎片和 2 个金属碎片。",
    "5 followers are  praying to the gods for Small Altar boons, each providing a 2% chance to receive a random god's Small Altar boon every minute.": "5 个追随者正在向众神祈祷小祭坛恩赐，每个追随者每分钟有 2% 的机会获得随机神的小祭坛恩赐。",
    "6 followers are  attempting to activate Small Altars that your party has fulfilled the conditions for, each providing a 25% chance to activate any Small Altar among your Activatable Altars every minute.": "6 个追随者正在尝试激活您的队伍已满足条件的小祭坛，每个追随者每分钟有 25% 的机会激活您的可激活祭坛中的任何小祭坛。",
    "Clicking Crab": "点击螃蟹",
    "Crafting material. Use at a Crafter or with a Profession to create new items.": "制作材料。 在工匠或专业人士中使用来创造新物品。",
    "Feral Harpy": "野生鹰身女妖",
    "Fervent Harpy": "狂热的鹰身女妖",
    "for the character equipped with Ares.": "对于装备阿瑞斯的角色。",
    "Harpy Queen": "鹰身女妖女王",
    "Increase Damage over Time Tick Frequency by": "随着时间的推移，损害频率增加",
    "Rambling Husk": "漫漫的外壳",
    "Red Snapper": "红鲷鱼",
    "Scaly Ring": "鳞环",
    "Soulless Husk": "无魂尸壳",
    "Territorial Harpy": "领地鹰身女妖",
    "View Achievements": "查看成就",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to deal an additional 265 damage. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "对队员的武器施加毒素，使他们的自动攻击有 10% 的几率造成额外 265 点伤害。 持续30分钟。 每个队员一次只能使用一种毒素。 这种效应在死亡后仍持续存在。",
    "and increase healing received by": "并增加接受的治疗",
    "Favorites": "收藏夹",
    "When viewing a class or god in the menu, hover their level to see a detailed breakdown of their XP modifiers.": "在菜单中查看某个职业或神时，将鼠标悬停在其等级上即可查看其 XP 修改器的详细细分。",
    "says. You nod in agreement. Something is clearly wrong here. You hope that you have seen the last of these mindless husks, but you have a strong feeling that the closer you get to Colchis, the more you will see.": "说。你点头表示同意。这里显然出了问题。你希望你已经看完了这些没有头脑的外壳，但你有一种强烈的感觉，你离科尔基斯越近，你看到的就越多。",
    "Jewelcrafting allows you to create items that augment your equipment, either through making gems that can slot into items to increase their stats or adding slots to existing equipment by clicking the Slot button when changing equipment.": "珠宝制作允许你创造道具来增强你的装备，或者通过制作宝石来增加道具的属性，或者在改变装备时点击插槽按钮为现有装备增加插槽。",
    "No matter what may come, you felt ready. At the beginning of your journey, you were filled with a bright-eyed confidence that was not earned. But now, you've overcome odds that most couldn't imagine. Maybe you aren't ready to slay a giant, but you're ready to give it your best shot.": "无论发生什么事，你都觉得自己准备好了。在你的旅程之初，你充满了一种来之不易的自信。但现在，你克服了大多数人无法想象的困难。也许你还没准备好杀死一个巨人，但你已经准备好尽你最大的努力。",
    "'Aigosthena'": "'艾格斯特纳'",
    "'Bay'": "'海湾'",
    "'menu'": "'菜单'",
    "'Upper Coast'": "'上海岸'",
    "Follower": "追随者",
    ", a massive serpent slithers its way through the forest. The Colchis Dragon, known around Greece as the immortal denizen of the Groves of": "一条巨大的蛇在森林中蜿蜒而行。科尔基斯龙，在希腊被认为是格罗夫斯的不朽居民",
    ". The serpent stops just short of its master, keeping a watchful eye on you.": "． 蛇在离主人不远的地方停了下来，警惕地盯着你。",
    ". To your surprise, the Golden Fleece that": "． 让你吃惊的是，金羊毛",
    "'Change Equipment'": "改变设备的",
    "“We will return and set things right. I want to be the kind of hero who abolishes the evil in this world, and I've never seen more evil in my life than in Colchis.": "“我们会回来，把事情纠正过来。我想成为那种消灭这个世界上邪恶的英雄，我一生中从未见过比科尔基斯更邪恶的人。",
    "As you proceed through the game, you will need to defeat enough enemies in each subzone before moving forward. You've won enough battles in the": "当你继续游戏时，你需要在每个子区域击败足够的敌人才能继续前进。你已经赢得了足够多的战斗",
    "bandits.": "土匪。",
    "But we'll need to be stronger. We'll need to figure out a way to beat": "但我们需要变得更坚强。我们得想个办法打败",
    "button again to toggle back to the main screen.": "按钮再次切换回主屏幕。",
    "button to update your equipment and then press the": "按钮更新您的设备，然后按下",
    "Coliseum Available!": "竞技场可用!",
    "fight to gain a massive amount of experience for your entire team.": "为整个团队争取大量的经验。",
    "Finally finding your voice, you rejoin the conversation.": "终于找到了自己的声音，你重新加入了对话。",
    "Grove of Ares": "阿瑞斯树林",
    "Include Side Quest Story": "包含支线任务故事",
    "Noticing your struggles,": "注意到你的挣扎，",
    "Oddly, the island was so quiet that it was as if no one ever resettled here. You could see evidence of homes and walking paths, but no people.": "奇怪的是，这个岛非常安静，好像从来没有人在这里定居过。你可以看到房屋和人行道的痕迹，但没有人。",
    "once was. Then come, see the Grove.”": "曾经。那就来看看树林吧。”",
    "Received": "收到了",
    "retrieved the Golden Fleece, the King of Colchis assigned him three impossible tasks. One was to defeat an army of men risen from the ground. I'm starting to think this could be the same magic.”": "为了取回金羊毛，科尔基斯国王给了他三个不可能完成的任务。一个是打败从地面上冒出来的军队。我开始认为这可能是同样的魔法。”",
    "Return to the coliseum throughout your journey for increasingly more difficult and rewarding battles. Use the special": "在你的旅程中，回到竞技场进行越来越困难和有益的战斗。使用特殊的",
    "says cheerily, pleased to see you getting back to yourself. The two of you make your way out of the forest and make for the coastal village of Iolcus, birthplace of": "高兴地说，很高兴看到你恢复正常。你们俩走出森林，前往沿海村庄伊俄克斯，他的出生地",
    "says from behind you. She begins a silent prayer as the majestic beast returns to grazing the forest.": "在你身后说。当这头威严的野兽返回森林吃草时，她开始默默祈祷。",
    "says sternly.": "严厉地说。",
    "says to you as you board the ship. As soon as you step onto the boat, the Colchian people stop following and merely watch. In the distance, you can see": "在你上船时对你说。你一踏上船，科尔喀斯人就不再跟着你，只是看着你。在远处，你可以看到",
    "says.": "说。",
    "so that we can become the hero he once was. We were just hoping to make it here and perhaps see the Grove of": "这样我们就可以成为他曾经的英雄。我们只是希望能赶到这里，也许能去看看树林",
    "Soon you come upon a beautiful grove known as the Grove of": "很快，你就来到了一个美丽的小树林，叫做",
    "subzone to continue. On the right side of the screen, select": "分区继续。在屏幕右侧，选择",
    "to move to the next subzone within the": "移动到下一个子区域",
    "toggle located on the top left of your screen. This will take you to your Class page, showing you every detail about your character. For now, use the": "位于屏幕左上方的开关。这将带你到你的类页面，向你展示你的角色的每一个细节。现在，使用",
    "Toggle sort direction:": "切换排序方向:",
    "Towns offer respite and the opportunity to trade. Click the 'General' option to see new equipment options.": "城镇提供了喘息的机会和贸易的机会。点击“General”选项查看新的装备选项。",
    "where the Golden Fleece once was, at least that was our goal before we were attacked. We came to you hoping you would know more about what we have seen on our travels.”": "金羊毛曾经在的地方，至少这是我们被攻击前的目标。我们来找你，希望你能更多地了解我们在旅行中所看到的。”",
    "You will temporarily lose access to previous Ballads after completing the following battle.": "完成以下战斗后，您将暂时无法访问以前的歌谣。",
    "You've acquired your first equipment item. Equipment can be changed by clicking the": "你已经获得了你的第一件装备。设备可以通过点击",
    "You've gained a reward by completing an achievement. View all achievements and rewards in the Menu under Achievements.": "你通过完成一项成就而获得奖励。在成就菜单中查看所有成就和奖励。",
    "zone. If you wish, you can select 'Auto Progress' at the top of the page to automatically move to the next subzone when possible. Continue proceeding through each subzone to progress the story.": "区。如果您愿意，您可以选择页面顶部的“自动进度”，以便在可能的情况下自动移动到下一个分区。继续通过每个子区域来推进故事。",
    "or to activate a Link in either mode.": "或以任何一种模式激活链接。",
    "to use ability in Manual mode": "在手动模式下使用能力",
    "When you manually select an ability, it will use one Link once the ability is used. If the ability deals direct damage, it will increase the damage by the percentage shown (10% in this instance). If the ability does not directly deal damage, it instead will increase the percentage by a significant amount. As you level up, you will be able to link abilities together and deal increasingly higher damage with them.": "当您手动选择一个能力，它将使用一个链接，一旦该能力被使用。如果该技能造成直接伤害，它将按显示的百分比增加伤害(在这个例子中是10%)。如果该技能不直接造成伤害，它反而会显著增加伤害百分比。当你升级时，你将能够将技能连接在一起并使用它们造成越来越高的伤害。",
    "You can now empower your abilities in the form of Links, displayed above your character's abilities like below:": "你现在可以以链接的形式赋予你的能力，显示在你的角色的能力上面，如下所示:",
    "You've obtained your first overdrive. A new bar is now under the unlocking character's health bar that shows their progress to using their overdrive. Attacking and being attacked by enemies increases your overdrive gauge, and once it reaches 100% you will enter a powerful state for a period of time. You can view the overdrive menu by selecting 'Change Overdrive' when looking at a class in the Menu.": "你第一次超速了。现在在解锁角色的生命条下方有一个新的条，显示他们使用超速驾驶的进度。攻击和被敌人攻击会增加你的超速指数，一旦达到100%，你会在一段时间内进入一个强大的状态。当在菜单中查看一个类时，您可以通过选择“更改超速”来查看超速菜单。",
    "“This is all I have for now, but if I get any new leads I'll let you know!”": "“我现在只有这些，但如果我有任何新的线索，我会告诉你的!”",
    "crafting materials": "制作材料",
    "Decrease direct damage taken by 35%.": "减少35%的直接伤害。",
    "Dealing 400 damage back to auto attackers.": "对自动攻击者造成400点伤害。",
    "Eternal Melee Tickets:": "永恒混战门票:",
    "Increase Healing Received by 25%.": "增加治疗效果25%",
    "View All Shops": "查看所有商店",
    "At Max Level": "在最高级",
    "Thales is assigned to the Priest class. Click for details on class.": "泰利斯被分配到牧师职业。点击查看职业详情。",
    "XP Per Second is calculated over a 120 second period and is reset upon changing sub zones. This does not include any XP modifiers such as Boon of Olympus.": "每秒经验值是在120秒内计算的，并在改变分区时重置。这并不包括任何经验修改，如奥林匹斯之恩。",
    "Zosime is assigned to the Adventurer class. Click for details on class.": "佐西美 被分配到冒险家职业。点击查看职业详情。",
    "Time": "时间",
    "HP": "生命值",
    "Monk": "僧侣",
    "'s cooldowns are reduced from Poseidon's Necklace's effect.": "受海神之坠效果影响，冷却时间缩短",
    "'s Sure Shot also applies a damage over time effect from Onslaught.": "精准射击可附加猛攻持续伤害效果",
    "'s Thyrsus also applies a damage over time effect from Onslaught.": "酒神权杖可附加猛攻持续伤害效果",
    "'Upper Coast - Reach 100 wins'": "【上游海岸——累计获胜100场】",
    "(1 blocked by barrier)": "（被屏障阻挡1个）",
    "A Champion": "传奇斗士",
    "Adamantine Amethyst": "精钢紫水晶",
    "Adamantine Aquamarine": "精钢海蓝宝",
    "Adamantine Emerald": "精钢祖母绿",
    "Adamantine Opal": "精钢欧泊",
    "Adamantine Ruby": "精钢红宝石",
    "Adamantine Topaz": "精钢黄玉",
    "Ambrosia:": "琼浆仙露：",
    "Armor Slot Addition": "防具栏位扩充",
    "Blessed Stone": "祈福圣石",
    "Brilliant Amethyst": "璀璨紫水晶",
    "Brilliant Aquamarine": "璀璨海蓝宝",
    "Brilliant Emerald": "璀璨祖母绿",
    "Brilliant Opal": "璀璨欧泊",
    "Brilliant Ruby": "璀璨红宝石",
    "Brilliant Topaz": "璀璨黄玉",
    "chance to make 2x as many items when making an Extraordinary quality Alchemy recipe.": "炼制超凡品质炼金配方时，有概率产出双倍成品",
    "chance to make 5x as many items when making an Extraordinary quality Alchemy recipe.": "炼制超凡品质炼金配方时，有概率产出五倍成品",
    "chance to reduce crafting time by half when making a Basic quality Jewelcrafting recipe.": "炼制普通品质珠宝配方时，有概率减半制作耗时",
    "chance to reduce crafting time by half when making a Rare quality Jewelcrafting recipe.": "炼制稀有品质珠宝配方时，有概率减半制作耗时",
    "chance to reduce crafting time by half when making a Special quality Jewelcrafting recipe.": "炼制珍稀品质珠宝配方时，有概率减半制作耗时",
    "chance to reduce crafting time by half when making a Unique quality Jewelcrafting recipe.": "炼制独有品质珠宝配方时，有概率减半制作耗时",
    "chance to reduce crafting time by half when making an Epic quality Jewelcrafting recipe.": "炼制史诗品质珠宝配方时，有概率减半制作耗时",
    "chance to reduce crafting time by half when making an Extraordinary quality Jewelcrafting recipe.": "炼制超凡品质珠宝配方时，有概率减半制作耗时",
    "chance to reduce crafting time by half when making an Uncommon quality Jewelcrafting recipe.": "炼制精良品质珠宝配方时，有概率减半制作耗时",
    "chance to retain your ingredients when making a Basic quality Jewelcrafting recipe.": "炼制普通品质珠宝配方时，有概率留存原材料",
    "chance to retain your ingredients when making a Rare quality Jewelcrafting recipe.": "炼制稀有品质珠宝配方时，有概率留存原材料",
    "chance to retain your ingredients when making a Special quality Jewelcrafting recipe.": "炼制珍稀品质珠宝配方时，有概率留存原材料",
    "chance to retain your ingredients when making a Unique quality Jewelcrafting recipe.": "炼制独有品质珠宝配方时，有概率留存原材料",
    "chance to retain your ingredients when making an Epic quality Jewelcrafting recipe.": "炼制史诗品质珠宝配方时，有概率留存原材料",
    "chance to retain your ingredients when making an Extraordinary quality Alchemy recipe.": "炼制超凡品质炼金配方时，有概率留存原材料",
    "chance to retain your ingredients when making an Extraordinary quality Jewelcrafting recipe.": "炼制超凡品质珠宝配方时，有概率留存原材料",
    "chance to retain your ingredients when making an Uncommon quality Jewelcrafting recipe.": "炼制精良品质珠宝配方时，有概率留存原材料",
    "chance to to gain an upgraded gem when making a Basic quality Jewelcrafting recipe.": "炼制普通品质珠宝配方时，有概率获得进阶宝石",
    "chance to to gain an upgraded gem when making a Rare quality Jewelcrafting recipe.": "炼制稀有品质珠宝配方时，有概率获得进阶宝石",
    "chance to to gain an upgraded gem when making a Special quality Jewelcrafting recipe.": "炼制珍稀品质珠宝配方时，有概率获得进阶宝石",
    "chance to to gain an upgraded gem when making a Unique quality Jewelcrafting recipe.": "炼制独有品质珠宝配方时，有概率获得进阶宝石",
    "chance to to gain an upgraded gem when making an Epic quality Jewelcrafting recipe.": "炼制史诗品质珠宝配方时，有概率获得进阶宝石",
    "chance to to gain an upgraded gem when making an Extraordinary quality Jewelcrafting recipe.": "炼制超凡品质珠宝配方时，有概率获得进阶宝石",
    "chance to to gain an upgraded gem when making an Uncommon quality Jewelcrafting recipe.": "炼制精良品质珠宝配方时，有概率获得进阶宝石",
    "Clicking on a class or god's name is a shortcut straight to their stat page.": "点击职业或神祇名称，可快速跳转至对应属性界面",
    "Cracked Amethyst": "碎裂紫水晶",
    "Cracked Emerald": "碎裂祖母绿",
    "Cracked Topaz": "碎裂黄玉",
    "Critical heal!": "暴击治疗！",
    "Critical tick!": "持续暴击！",
    "Dionysus": "狄俄尼索斯",
    "Dull Amethyst": "暗沉紫水晶",
    "Dull Aquamarine": "暗沉海蓝宝",
    "Dull Emerald": "暗沉祖母绿",
    "Dull Opal": "暗沉欧泊",
    "Dull Ruby": "暗沉红宝石",
    "Dull Topaz": "暗沉黄玉",
    "Extraction": "精粹萃取",
    "Flawed Amethyst": "瑕疵紫水晶",
    "Flawed Aquamarine": "瑕疵海蓝宝",
    "Flawed Emerald": "瑕疵祖母绿",
    "Flawed Opal": "瑕疵欧泊",
    "Flawed Ruby": "瑕疵红宝石",
    "Flawed Topaz": "瑕疵黄玉",
    "Flawless Amethyst": "无瑕紫水晶",
    "Flawless Aquamarine": "无瑕海蓝宝",
    "Flawless Emerald": "无瑕祖母绿",
    "Flawless Opal": "无瑕欧泊",
    "Flawless Ruby": "无瑕红宝石",
    "Flawless Topaz": "无瑕黄玉",
    "Jagged Stone": "嶙峋顽石",
    "Major Armor Slot Addition": "大型防具栏位扩充",
    "Major Necklace Slot Addition": "大型项链栏位扩充",
    "Major Ring Slot Addition": "大型戒指栏位扩充",
    "Major Shield Slot Addition": "大型盾牌栏位扩充",
    "Major Weapon Slot Addition": "大型武器栏位扩充",
    "Minor Necklace Slot Addition": "小型项链栏位扩充",
    "Minor Ring Slot Addition": "小型戒指栏位扩充",
    "Minor Shield Slot Addition": "小型盾牌栏位扩充",
    "Minor Weapon Slot Addition": "小型武器栏位扩充",
    "Necklace Slot Addition": "项链栏位扩充",
    "Olympus": "奥林匹斯",
    "Poseidon": "波塞冬",
    "Radiating Air Stone": "逸散风灵石",
    "Radiating Earth Stone": "逸散地灵石",
    "Radiating Fire Stone": "逸散火灵石",
    "Radiating Lightning Stone": "逸散雷灵石",
    "Radiating Water Stone": "逸散水灵石",
    "Redemption": "救赎之力",
    "RES": "抗性",
    "Ring Slot Addition": "戒指栏位扩充",
    "Rutilated Amethyst": "发晶紫水晶",
    "Rutilated Aquamarine": "发晶海蓝宝",
    "Rutilated Emerald": "发晶祖母绿",
    "Rutilated Opal": "发晶欧泊",
    "Rutilated Ruby": "发晶红宝石",
    "Rutilated Topaz": "发晶黄玉",
    "Shield Slot Addition": "盾牌栏位扩充",
    "shields": "盾牌装备",
    "The Argo": "阿尔戈号",
    "The Boar": "狂野猪",
    "The Eagle": "雄鹰",
    ...
    "The Labors": "十二试炼",
    "The Labyrinth": "无尽迷域",
    "The time it takes to create a Basic quality Jewelcrafting Recipe is reduced by": "普通品质珠宝配方制作时长缩减",
    "The time it takes to create a Rare quality Jewelcrafting Recipe is reduced by": "稀有品质珠宝配方制作时长缩减",
    "The time it takes to create a Special quality Jewelcrafting Recipe is reduced by": "珍稀品质珠宝配方制作时长缩减",
    "The time it takes to create a Unique quality Jewelcrafting Recipe is reduced by": "独有品质珠宝配方制作时长缩减",
    "The time it takes to create an Epic quality Jewelcrafting Recipe is reduced by": "史诗品质珠宝配方制作时长缩减",
    "The time it takes to create an Extraordinary quality Jewelcrafting Recipe is reduced by": "超凡品质珠宝配方制作时长缩减",
    "The time it takes to create an Uncommon quality Jewelcrafting Recipe is reduced by": "精良品质珠宝配方制作时长缩减",
    "The Underworld": "幽冥地府",
    "The Witch": "巫影魔女",
    "Up to 120 minutes of away time is automated. You can adjust the length of automated away time in the settings.": "最长可自动挂机离线120分钟，可在设置中调整离线挂机时长",
    "uses Crashing Waves on": "对目标施展狂涛巨浪",
    "uses Have a Drink.": "施展举杯畅饮",
    "uses Insanity.": "施展狂乱心智",
    "uses Nimble Strike on": "对目标施展迅捷突刺",
    "uses Onslaught.": "施展猛攻之势",
    "uses Palm Strike on": "对目标施展掌法重击",
    "uses Pinning Shot on": "对目标施展禁锢箭矢",
    "uses Revelry.": "纵情狂欢",
    "uses Rupture.": "破甲撕裂",
    "uses Special Delivery.": "精准速递",
    "uses Spirit Unleashed on": "对目标释放灵体觉醒",
    "uses Take Flight.": "凌空腾飞",
    "uses Thyrsus on": "对目标挥舞酒神权杖",
    "uses Tsunami on": "对目标掀起滔天海啸",
    "uses Whirlpool on": "对目标施展漩涡之力",
    "Water": "水系之力",
    "Weapon Slot Addition": "武器栏位扩充",
    "You gain an additional": "额外获得",
    "You learn how to make the Alchemy recipe:": "习得全新炼金配方：",
    "You learn how to make the Jewelcrafting recipe:": "习得全新珠宝打造配方：",
    " Rotate between giving your target a debuff to increase their damage taken by": "给你的目标一个debuff来增加他们所受的伤害，",
    ", or reduce their Auto Attack Speed by": "或将其自动攻击速度降低",
    ", reduce their damage dealt by": "，减少他们所造成的伤害",
    "%. Passive.": "%。被动效果。",
    "After dealing Water damage with an ability, subsequent Water damaging abilities will immediately reduce their cooldown by": "在使用技能造成水属性伤害后，后续的水属性伤害技能会立即减少其冷却时间",
    "Always Active - Shield of Unending Flames": "始终可用 - 无尽火焰之盾",
    "and hit all targets. 6.41 second cooldown.": "并同时作用于所有目标。冷却时间为 6.41 秒。",
    "Archer:": "弓箭手：",
    "Ares:": "阿瑞斯：",
    "Crashing Waves": "冲击波",
    "Crustacean A": "甲壳类A",
    "Crustacean B": "甲壳类B",
    "damage and apply a Palm Strike debuff to the target. Every third Palm Strike on a target will increase the effectiveness by": "造成伤害并对目标施加手掌打击debuff。每对目标进行第三次掌击，将使效果提高",
    "damage to a target 3 times and give the user King of the Sea, increasing Damage Dealt by": "对目标造成3次伤害，并给予使用者海之王，增加造成的伤害",
    "damage to a target and apply": "对目标造成伤害并施放",
    "damage to a target and increase the damage they take by": "对目标造成伤害，并增加他们所受的伤害",
    "damage to all targets. If the previous ability used was a Poseidon ability, increase the damage dealt by": "对所有目标造成伤害。如果之前使用的技能是波塞冬的技能，则增加对目标造成的伤害",
    "Dionysus:": "狄俄尼索斯：",
    "Favored food of the gods. Use to buy special items and upgrades from the Olympic Favor menu.": "众神的偏爱食物。用于从奥林匹克偏爱菜单中购买特殊物品和升级。",
    "Frenzied Gull A": "狂暴海鸥 A",
    "Frenzied Gull B": "狂暴海鸥 B",
    "Grant a party member a": "赋予一名团队成员一个",
    "Hermes:": "赫尔墨斯：",
    "If your next ability deals Water damage, immediately reduce its cooldown by 24.82%.": "如果你的下一个技能造成水属性伤害，立即将其冷却时间减少 24.82%。",
    "Insanity": "疯狂",
    "Monk:": "僧侣：",
    "of their Max HP. Increase the effectiveness of the shield by": "最大生命值的一半。提高护盾的效力",
    "Palm Strike": "掌击",
    "per active buff you have. Targets the party member with the lowest HP %. 25.97 second cooldown.": "每一个你拥有的主动buff。针对生命值百分比最低的队员施加效果。25.97 秒的冷却时间。",
    "per active unique debuff the target has, up to 15 debuffs. 38.61 second cooldown.": "针对目标所拥有的每种独特控制效果（最多 15 种效果），其冷却时间分别为：38.61 秒。",
    "Poseidon:": "波塞冬：",
    "random stat decreasing debuffs amongst enemies (Excluding Max HP). Each effect reduces the stat by": "对敌人随机施加降低属性的控制效果（不包括最大生命值）。每种效果会使属性降低",
    "Randomly distribute": "随机分配",
    "Revelry": "狂欢",
    "seconds for each hit. If the previous ability used was a Poseidon ability, the ability hits 2 more times. 39.19 second cooldown.": "每次命中的秒数。如果之前使用的技能是珀尔修斯系列技能，那么该技能将额外攻击 2 次。冷却时间为 39.19 秒。",
    "seconds. If the previous ability used was a Poseidon ability, increase effect duration by": "秒数。如果先前使用的技能是波塞冬技能，则效果持续时间增加",
    "seconds. If the target already has a debuff of that type, increase its duration by": "秒。如果目标已经拥有该类型的负面效果，其持续时间将增加",
    "seconds. Increase duration by": "秒数。持续时间将增加",
    "seconds. Increase the effectiveness of the debuff by": "秒数。负面效果的效力将增加",
    "See a brief overview of your Time Fragment status.": "查看您的时间碎片状态的简要概述。",
    "Spend on permanent stat boosts.": "用于永久性属性提升。",
    "Spirit Unleashed": "精神释放",
    "Thyrsus": "提尔斯海啸",
    "Tsunami": "不稳定状态",
    "Unsteady for": "不稳定",
    "uses Insight, restoring 2 HP to Monk.": "使用洞察力，为僧侣恢复2点生命值。",
    "uses Peck on": "使用Peck",
    "Whirlpool": "漩涡",
    "Your next damaging ability will also apply a damage over time effect onto its targets.": "你的下一个具有破坏力的技能还会对目标施加持续伤害的效果。",
    "Absorb Water damage equal to 10% of your Max HP for 30 seconds. 10 second cooldown.": "吸收等同于自身最大生命值10%的水系伤害，持续30秒，冷却10秒",
    "Activate one random Large Altar boon effect from every available god. Target a party member to use.": "随机激活所有已有神祇各一种大型神坛赐福效果，可对队友施放",
    "Activate one random Small Altar boon effect from every available god. Target a party member to use.": "随机激活所有已有神祇各一种小型神坛赐福效果，可对队友施放",
    "Agonizing Toxin": "蚀骨剧毒",
    "Apply a toxin to a party member's weapon, causing all auto attacks and non-elemental abilities to take on the Air element. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，使其普攻与无属性技能转为风属性，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, causing all auto attacks and non-elemental abilities to take on the Holy element. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，使其普攻与无属性技能转为圣属性，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, causing all auto attacks and non-elemental abilities to take on the Water element. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，使其普攻与无属性技能转为水属性，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to deal an additional 185K damage. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，普攻有10%几率额外造成18.5万伤害，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to deal an additional 982 damage. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，普攻有10%几率额外造成982点伤害，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to increase a target's Ability Cooldowns by 20% for 15 seconds. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，普攻有10%几率延长目标技能冷却20%，持续15秒，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to reduce a target's Attack by 20% for 16 seconds. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，普攻有10%几率降低目标20%攻击力，持续16秒，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Apply a toxin to a party member's weapon, giving their auto attacks a 10% chance to reduce a target's Defense by 20% for 20 seconds. Lasts for 30 minutes. Only one toxin can be applied per party member at a time. This effect persists on death.": "为队友武器涂抹毒素，普攻有10%几率降低目标20%防御力，持续20秒，持续30分钟，每人仅可附着一种，阵亡效果不消失",
    "Booming Potion": "轰鸣药剂",
    "Bouncing Potion": "弹跳药剂",
    "Bursting Potion": "爆裂药剂",
    "Corrosive Toxin": "腐蚀毒素",
    "Deal 1.75K damage + 6% of a target's HP up to 24.0K damage twice.": "造成1750点伤害外加目标6%生命值，上限24000点，共计两段伤害",
    "Deal 15.0K damage + 10% of a target's HP up to 250K damage ten times.": "造成15000点伤害外加目标10%生命值，上限25万点，共计十段伤害",
    "Deal 3.50K damage + 5% of a target's HP up to 32.0K damage to each enemy twice.": "对每名敌人造成3500点伤害外加目标5%生命值，上限32000点，共计两段伤害",
    "Deal 5.50K damage + 7.5% of a target's HP up to 75.0K damage three times.": "造成5500点伤害外加目标7.5%生命值，上限75000点，共计三段伤害",
    "Deal 8.00K damage + 6% of a target's HP up to 100K damage to each enemy three times.": "对每名敌人造成8000点伤害外加目标6%生命值，上限10万点，共计三段伤害",
    "Elixir of Power": "力量灵药",
    "Elixir of Will": "意志灵药",
    "Endless Potion": "无尽药剂",
    "Heal both party members for 12.5K HP and an additional 1% of their Max HP.": "为两名队友恢复12500点生命值，额外回复1%最大生命值",
    "Heal both party members for 6.50K HP and an additional 0.75% of their Max HP.": "为两名队友恢复6500点生命值，额外回复0.75%最大生命值",
    "Increase user's Attack by 10% for 30 minutes. Only one elixir can be active per party member at a time. This effect persists on death.": "自身攻击力提升10%，持续30分钟，每人仅可生效一种灵药，阵亡效果保留",
    "Increase user's HP Regen by 50 HP per 5 seconds for 30 minutes. Only one elixir can be active per party member at a time. This effect persists on death.": "自身每5秒恢复50点生命值，持续30分钟，每人仅可生效一种灵药，阵亡效果保留",
    "Increase user's Resistance by 10% for 30 minutes. Only one elixir can be active per party member at a time. This effect persists on death.": "自身抗性提升10%，持续30分钟，每人仅可生效一种灵药，阵亡效果保留",
    "Increase user's Thorns by 100% for 30 minutes. Only one elixir can be active per party member at a time. This effect persists on death.": "自身反伤效果翻倍，持续30分钟，每人仅可生效一种灵药，阵亡效果保留",
    "Ink Poultice": "墨色药膏",
    "Ink Salve": "墨色膏霜",
    "Item is consumed after using.": "使用后消耗该物品",
    "Light Toxin": "轻灵毒素",
    "Metal Elixir": "坚金灵药",
    "Peony Poultice": "牡丹药膏",
    "Peony Salve": "牡丹膏霜",
    "Reduce target's Resistance by 20% for 20 seconds.": "降低目标20%抗性，持续20秒",
    "Regen 5% of user's Max HP per 5 seconds for 30 minutes. Only one elixir can be active per party member at a time. This effect persists on death.": "自身每5秒恢复5%最大生命值，持续30分钟，每人仅可生效一种灵药，阵亡效果保留",
    "Rejuvenating Elixir": "焕生灵药",
    "Restorative Elixir": "愈伤灵药",
    "Shattering Potion": "碎击药剂",
    "Tempest Toxin": "风暴毒素",
    "Tidal Toxin": "潮汐毒素",
    "Token of Favor": "恩赐徽记",
    "Token of Support": "助力徽记",
    "Unsteadying Toxin": "晃神毒素",
    "Venomous Toxin": "剧毒蚀骨",
    "Water Absorption Potion": "吸水药剂",
    "Wild Potion": "狂化药剂",
    "Withering Toxin": "凋零毒素",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Hidden Oasis": "隐藏的绿洲",
    "Desert Sands": "沙漠之沙",
    "Libyan Outskirts": "利比亚郊区",
    "Saharan Dunes": "撒哈拉沙丘",
    "Moroccan Coast": "摩洛哥海岸",
    "Southern Cretan Seas": "南克里特海",
    "Thirsty Lion": "口渴的狮子",
    "Garden of the Hesperides - ": "赫斯珀里得斯花园 - ",
    "Darkened Meadows": "黑暗的草地",
    "Fiery Passage": "火热的通道",
    ...
    "Forgotten Halls": "被遗忘的大厅",
    "Endless Staircase": "无尽的楼梯",
    "Permanent Stat Gain: ": "永久属性增益：",
    "River Divergence": "河流分叉",
    "Pillars of Heracles": "海格力斯之柱",
    "Geryon's Farm": "格律翁农场",
    "Fallen Hero": "阵亡的英雄",
    "Elysium - ": "极乐世界 - ",
    "Erytheia - ": "厄律忒亚 - ",
    "Forgetful Shade": "遗忘的阴影",
    "Singing Siren": "歌唱的海妖",
    "The Lethe - ": "忘川 - ",
    "Wheel of Flames": "火焰之轮",
    "Hypnos' Island": "催眠岛",
    "Island of Erytheia": "厄里西亚岛",
    "Nightmare Monstrosity": "梦魇怪物",
    "Creature From The Deep": "深海生物",
    "Lush Valley": "郁郁葱葱的山谷",
    "Eagle Eye": "鹰眼",
    "Diamond Hammer": "钻石锤",
    "Black Lance": "黑色长矛",
    ...
    "Golden Sword": "金剑",
    "Monster Dentex": "怪物牙",
    "aves of Oceanus": "海洋中的鸟",
    "Western Ocean Waters": "西大洋水域",
    "Basking Shark": "姥鲨",
    "Blinded Villager": "失明的村民",
    "Aggravated Hunter": "愤怒的猎人",
    "Fiery Newt": "火热蝾螈",
    "game speed: ": "游戏速度：",
    ...
    "Highest DPS Achieved: ": "达到的最高 DPS：",
    "Highest XPS Achieved: ": "达到的最高 XPS：",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    " available)": " 可用)",
    " remaining)": " 剩余)",
    "% Overdrive Gain Permanently": "% 永久超频增益",
    " (Town)": "（镇）",
    " Large Charm of Holy Protection": " 大圣护符",
    " Large Charm of Ingenuity": " 匠心之大魅力",
    " Large Charm of Rejuvenation": " 回春大魅力",
    " Small Black Kantharos": " 小黑坎塔罗",
    " Small Bucchero Kantharos": " 小布切罗坎塔罗斯",
    " Small Cracked Kantharos": " 小裂纹坎塔罗",
    " Small Gilded Kantharos": " 小镀金坎塔罗斯",
    " Small Silver Kantharos": " 小银坎塔罗斯",
    " Lesser Cracked Amethyst": " 小裂纹紫水晶",
    " Lesser Cracked Aquamarine": " 小裂纹海蓝宝石",
...
var cnRegReplace = new Map([
    ...
    [/^chance to receive (.+) items:$/, '获得 $1 物品的机会：'],
    [/^damage every (.+) seconds for$/, '每 $1 秒造成伤害'],
    [/^of their Max HP. (.+) second cooldown.$/, '他们的最大生命。$1 秒冷却时间。'],
    [/^. (.+) total stacks worth (.+) each.$/, '． $1 层堆叠，每层堆叠价值 $2。'],
    [/^Your next auto attack will also heal you for (.+) HP.$/, '你的下一次自动攻击也会治疗你 $1 点生命值。'],
    [/^Heal a party member for (.+) HP.$/, '治疗一名队员 $1 生命值。'],
    [/^takes (.+) damage from Rupture's effect.$/, '受到来自破裂效果的 $1 伤害。'],
    [/^uses Insight, restoring (.+) HP to Archer.$/, '使用洞察力，为射手恢复 $1 生命值。'],
    [/^uses Revel in Blood, losing (.+) HP and applying a damage over time effect on all enemies.$/, '沉浸血宴，损耗 $1 生命值，对全体敌人附加持续伤害效果'],
    [/^Dealing (.+) damage back to auto attackers.$/, '造成 $1 伤害到自动攻击者.'],
    ...
    [/^after each auto attack or ability. This effect stacks up to (.+) times.(.+) second cooldown.$/, '每次自动攻击或技能后。 此效果最多堆叠 $1次。$2 秒冷却时间。'],
    [/^after each auto attack or ability. (.+) second cooldown.$/, '每次自动攻击或技能后。 $1 秒冷却时间。'],
    [/^Poison an enemy, dealing (.+) damage every (.+) seconds for (.+) seconds.$/, '使一个敌人中毒，每 $2 秒造成 $1 点伤害，持续 $3 秒。'],
    [/^Poison all enemies, dealing (.+) damage every (.+) seconds for (.+) seconds.$/, '使所有敌人中毒，每 $2 秒造成 $1 点伤害，持续 $3 秒。'],
    ...
    [/^([\d\.]+) elves$/, '$1 精灵'],
    [/^for ([\d\.]+)M$/, '造成 $1M'],
    [/^for ([\d\.]+)M damage.$/, '造成 $1M 伤害.'],
    [/^XP to Level ([\d\.]+)$/, '经验值到等级 $1'],
    ...
    [/^([\d\.,]+)\% Agility$/, '$1\% 敏捷'],
    [/^([\d\.,]+)\% of Defense$/, '$1\% 防御'],
    [/^([\d\.,]+)\% of Resistance$/, '$1\% 抵抗'],
    [/^([\d\.,]+)\% of HP Loss$/, '$1\% 生命丢失'],
    [/^Increase damage dealt by ([\d\.,]+)\%.$/, '提高所造成的伤害值 $1\%.'],
    [/^Increase Resistance by ([\d\.,]+)\%.$/, '提高 抵抗 $1\%.'],
    [/^\+([\d\.,]+) Small Charm of Ingenuity$/, '\+$1 独创的小护身符'],
    [/^\+([\d\.,]+) Poison Extract Potion Recipe$/, '\+$1 毒液提取物配方'],
    [/^\+([\d\.,]+) Poison Fang$/, '\+$1 毒牙'],
    [/^\+([\d\.,]+) Luck Permanently$/, '\+$1 永久幸运'],
    [/^\+([\d\.,]+) Defense Permanently$/, '\+$1 永久防御'],
    [/^\+([\d\.,]+) jewelcrafting XP$/, '\+$1 珠宝加工 经验'],
    [/^\+([\d\.,]+) Max HP Permanently$/, '\+$1 永久最大生命值'],
    [/^\+([\d\.,]+) Metal Scraps$/, '\+$1 金属废料'],
    [/^\+([\d\.,]+) alchemy XP$/, '\+$1 炼金术经验'],
    [/^([\d\.,]+) Hefty Stone$/, '$1 巨石'],
    [/^([\d\.,]+) Vial of Lake Lerna$/, '$1 勒纳湖的小瓶'],
    [/^([\d\.,]+) Vial of the Lethe$/, '$1 忘川之瓶'],
    [/^([\d\.,]+) Soul Essence$/, '$1 灵魂精华'],
    [/^([\d\.,]+) Healing Herb$/, '$1 治疗药草'],
    [/^([\d\.,]+) Soul Spark$/, '$1 灵魂火花'],
    [/^([\d\.,]+) Bushel of Herbs$/, '$1 蒲式耳草药'],
    [/^([\d\.,]+) Satchel of Herbs$/, '$1 一包草药'],
    [/^([\d\.,]+) Fennel$/, '$1 茴香'],
    [/^([\d\.,]+) Thorns$/, '$1 荆棘'],
    [/^([\d\.,]+) HP Regen$/, '$1 生命值恢复'],
    [/^([\d\.,]+) Bonus XP$/, '$1 奖励经验'],
    ...
    [/^([\d\.,]+) Poison Fang$/, '$1 毒牙'],
    [/^([\d\.,]+) Essence of Fire$/, '$1 火之精华'],
    [/^([\d\.,]+) Serpent Scale$/, '$1 蛇鳞'],
    [/^([\d\.,]+) Coins$/, '$1 金币'],
    ...
    [/^([\d\.,]+) Coarse Fur$/, '$1 粗皮毛'],
    [/^([\d\.,]+) MIN$/, '$1 分钟'],
    [/^([\d\.,]+) second cooldown.$/, '$1 秒冷却'],
    [/^([\d\.,]+) HR$/, '$1 小时'],
    [/^([\d\.,]+) Healing Herbs$/, '$1 治疗草药'],
    [/^([\d\.,]+) Luck$/, '$1 幸运'],
    ...
    [/^Upgrade ([\d\.,]+)$/, '升级 $1'],
    [/^Class ([\d\.,]+):$/, '职业 $1:'],
    [/^and ([\d\.,]+) other locations.$/, '和其他 $1 个地点。'],
    [/^Class ([\d\.,]+) Armor:$/, '职业 $1 盔甲:'],
    [/^Class ([\d\.,]+) Necklace:$/, '职业 $1 项链:'],
    [/^Class ([\d\.,]+) Ring:$/, '职业 $1 戒指:'],
    [/^Class ([\d\.,]+) Shield:$/, '职业 $1 盾牌:'],
    [/^Class ([\d\.,]+) Weapon:$/, '职业 $1 武器:'],
    [/^God ([\d\.,]+):$/, '神明 $1:'],
    [/^Lethe Basin ([\d\.,]+)$/, '忘川盆地 $1'],
    [/^Hellespont Passage ([\d\.,]+)$/, '赫勒斯滂海峡 $1'],
    [/^Lv ([\d\.,]+)$/, '等级 $1'],
